package com.vynkpay.activity.recharge.dth.fragment;
...
import com.vynkpay.activity.recharge.dth.adapter.DthPlanAdapter;
...
public class ThreeMonthlyFragment extends Fragment {
...
String type="";
    ...
    private void makePlanListingCall() {
        ...
        String url=BuildConfig.APP_BASE_URL + URLS.dth_plans + "?operator=" + Prefes.getOperator(getActivity())+ "&recharge_type=" + "3 Month Packs" + "&page=" + count;
        String SURL=url.replace(" ","%20");

        Log.d("threemOnthDTHLOG", SURL);
