...
public class DataCardPlanAdapter extends RecyclerView.Adapter<DataCardPlanAdapter.MyViewHolder> {
    private ArrayList<PlanModel> operatorList;
    Context context;
    OnBottomReachedListener onBottomReachedListener;

    public DataCardPlanAdapter(Context context, ArrayList<PlanModel> data) {
