...
import com.vynkpay.activity.recharge.dth.adapter.DthOperatorAdapter;
...
public class SelectDthOperatorActivity extends AppCompatActivity {
    ...
    String type;
    DthOperatorAdapter prepaidOperatorAdapter;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dth_operator_rcg);
        ButterKnife.bind(SelectDthOperatorActivity.this);
        dialog = M.showDialog(SelectDthOperatorActivity.this, "", true, true);
        ...
        prepaidOperatorAdapter = new DthOperatorAdapter(SelectDthOperatorActivity.this, oprtaorArrayList, type);
    ...
    private void makeOperatorFetchNetworkCall() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (mSuccess.equalsIgnoreCase("true")) {
                                ...
                                M.dialogOk(SelectDthOperatorActivity.this, mMessage, "Error!");
                            }
                        } catch (Exception e) {
        ...
        MySingleton.getInstance(SelectDthOperatorActivity.this).addToRequestQueue(stringRequest);
