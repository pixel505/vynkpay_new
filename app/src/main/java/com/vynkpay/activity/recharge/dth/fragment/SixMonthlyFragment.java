...
public class SixMonthlyFragment extends Fragment {
   ...
   // Dialog dialog;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ButterKnife.bind(SixMonthlyFragment.this, view);
    ...
    private void makePlanListingCall() {
        ...
        Log.i(">>url", "makePlanListingCall: " +
                BuildConfig.APP_BASE_URL +
                URLS.dth_plans + "?operator=" + Prefes.getOperator(getActivity()).replaceAll(" ", "%20") +
