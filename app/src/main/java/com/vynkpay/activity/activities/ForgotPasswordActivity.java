...
public class ForgotPasswordActivity extends AppCompatActivity implements PlugInControlReceiver.ConnectivityReceiverListener {
    ...
    protected void onResume() {
        super.onResume();
        MySingleton.getInstance(ForgotPasswordActivity.this).setConnectivityListener(this);
    }

    @Override
    public void onNetworkConnectionChanged(boolean isConnected) {
        if (isConnected){
            M.showUSBPopUp(ForgotPasswordActivity.this,ForgotPasswordActivity.this::finishAffinity);
        }
    }
}
