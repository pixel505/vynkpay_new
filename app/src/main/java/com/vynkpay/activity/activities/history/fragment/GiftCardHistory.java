...
public class GiftCardHistory extends Fragment {
    String accessToken;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ButterKnife.bind(GiftCardHistory.this, view);
    ...
    private void previousTransferData() {
        ...
        dialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.GET, BuildConfig.APP_BASE_URL + URLS.historyGiftCard,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Log.i(">>giftCardHistory", "onResponse: " + response);
