...
public class CashbackRewardActivity extends AppCompatActivity implements PlugInControlReceiver.ConnectivityReceiverListener {
    ...
    protected void onResume() {
        super.onResume();
        MySingleton.getInstance(CashbackRewardActivity.this).setConnectivityListener(this);
    }

    @Override
    public void onNetworkConnectionChanged(boolean isConnected) {
        if (isConnected){
            M.showUSBPopUp(CashbackRewardActivity.this,CashbackRewardActivity.this::finishAffinity);
        }
    }
}
