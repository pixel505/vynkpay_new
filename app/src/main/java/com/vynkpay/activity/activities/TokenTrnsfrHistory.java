...
public class TokenTrnsfrHistory extends AppCompatActivity {
    ...
    private void clicks() {
        ...
        binding.toolbarTitle.setText("Tokens Transfer History");
    }

    private void dev() {
        binding.chainRV.setLayoutManager(Functions.layoutManager(this, Functions.VERTICAL, 0));
        transferHistoryAdapter = new TransferHistoryAdapter(this, chainTransactionModelArrayList);
