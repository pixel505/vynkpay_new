...
import com.vynkpay.activity.giftcards.activity.SingleGiftCardActivity;
...
public class GiftCardAdapter extends RecyclerView.Adapter<GiftCardAdapter.MyViewHolder> {
    ...
    public GiftCardAdapter(Context context, ArrayList<GiftCardModel> giftCardModelArrayList) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.seeAllButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, SingleGiftCardActivity.class);
    ...
    private void handleOperatorResponse(JSONObject jsonObject, final MyViewHolder holder) {
        ...
        try {
            ...
            GiftCardCategoryListingAdapter giftCardCategoryListingAdapter = new GiftCardCategoryListingAdapter(context, giftCardListModelArrayList);
    ...
    private JSONObject getOperatorData(String categoryId, MyViewHolder holder) throws ExecutionException, InterruptedException, RuntimeException {
        ...
        String Url = BuildConfig.APP_BASE_URL + URLS.giftCardProducts + "?category_id=" + categoryId;
