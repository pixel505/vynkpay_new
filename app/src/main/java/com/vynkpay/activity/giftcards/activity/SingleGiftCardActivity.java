...
public class SingleGiftCardActivity extends AppCompatActivity implements PlugInControlReceiver.ConnectivityReceiverListener {
    Dialog dialog;
    ...
    protected void onResume() {
        super.onResume();
        MySingleton.getInstance(SingleGiftCardActivity.this).setConnectivityListener(this);
    }

    @Override
    public void onNetworkConnectionChanged(boolean isConnected) {
        if (isConnected){
            M.showUSBPopUp(SingleGiftCardActivity.this,SingleGiftCardActivity.this::finishAffinity);
        }
    }
}
