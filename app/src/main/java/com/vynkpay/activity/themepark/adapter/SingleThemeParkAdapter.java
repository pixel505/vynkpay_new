...
public class SingleThemeParkAdapter extends RecyclerView.Adapter<SingleThemeParkAdapter.MyViewHolder> {
    Context context;
    ArrayList<GiftListModel> giftCardModelArrayList;

    public SingleThemeParkAdapter(Context context, ArrayList<GiftListModel> giftCardModelArrayList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        if (!giftCardModelArrayList.get(position).getImage().isEmpty()) {
            Picasso.get().load(giftCardModelArrayList.get(position).getImage()).placeholder(R.drawable.logo).error(R.drawable.logo).into(holder.giftImage);
        }
        holder.giftTitle.setText(giftCardModelArrayList.get(position).getCity() + "/" + giftCardModelArrayList.get(position).getCountry());
        ...
        holder.giftButton.setText(Functions.CURRENCY_SYMBOL + giftCardModelArrayList.get(position).getPrice());
