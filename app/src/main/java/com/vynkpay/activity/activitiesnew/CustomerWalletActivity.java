...
public class CustomerWalletActivity extends AppCompatActivity implements PlugInControlReceiver.ConnectivityReceiverListener {
    ...
    private void clicks() {
        ...
        binding.toolbarLayout.toolbarnew.setNavigationOnClickListener(view -> finish());
        ...
        if (Prefes.getUserType(CustomerWalletActivity.this).equalsIgnoreCase("2")){
            binding.tvWTitle.setText("Cashback");
            binding.bonusCard.setVisibility(View.VISIBLE);
        }else {
            binding.bonusCard.setVisibility(View.VISIBLE);
            binding.tvWTitle.setText("Bonus Wallet");
        }
        ...
        binding.transferWallet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(CustomerWalletActivity.this, TranferWalletActivity.class));
            }
        });
        ...
        binding.reqstWithdrawalCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (Functions.isIndian) {
                    ...
                    startActivity(new Intent(CustomerWalletActivity.this, RequestWithdrawnActivity.class));
                }else {
                    //popupWithdrawalAmountIntern();
                    startActivity(new Intent(CustomerWalletActivity.this, WithdrawTypeActivity.class));
                }
            }
        });
         ...
         binding.loadMcash.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(CustomerWalletActivity.this, LoadmcashActivity.class));
            }
        });
